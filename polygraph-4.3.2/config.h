...
#define CONFIG_HOST_TYPE "x86_64-apple-darwin13.2.0"
...
/* */
#define HAVE_TYPE_IFALIASREQ 1

/* */
#define HAVE_TYPE_IFREQ 1

/* */
#define HAVE_TYPE_IN6_ALIASREQ 1

/* */
#define HAVE_TYPE_IN6_IFREQ 1
